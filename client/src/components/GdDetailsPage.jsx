...
const GdDetailsPage = () => {
  ...
  const recalculateDerivedFields = (item) => {
    ...
    return { retail_price: retailPrice.toFixed(2), per_unit_sales_tax: perUnitSalesTax.toFixed(2), mrp: mrp.toFixed(2), gross_margin: grossMargin.toFixed(2), sale_price: salePrice.toFixed(2) };
  };
  ...
  if (!gd) return <div className="text-center py-5"><Spinner animation="border" /></div>;
